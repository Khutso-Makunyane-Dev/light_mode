...
export default function YearCard() {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-1 sm:gap-3 w-full p-2 sm:p-8">
      <StatCard start={0} end={2} label="Years of Experience as Designer & Full stack" duration={2000} delay={60000} />
      ...
      <StatCard start={0} end={8} label="Tech Languages" duration={2500} delay={60000} />
    </div>
  );
}
